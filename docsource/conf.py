...
htmlhelp_basename = 'FAAMCalibrationncdoc'
...
latex_documents = [
    (master_doc, 'FAAMCalibrationnc.tex', 'FAAM Calibration nc Documentation',
     'Graeme Nott', 'manual'),
]
...
man_pages = [
    (master_doc, 'faamcalibrationnc', 'FAAM Calibration nc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'FAAMCalibrationnc', 'FAAM Calibration nc Documentation',
     author, 'FAAMCalibrationnc', 'One line description of project.',
     'Miscellaneous'),
]
